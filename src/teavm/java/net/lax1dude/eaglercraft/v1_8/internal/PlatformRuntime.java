...
public class PlatformRuntime {
	...
	@JSBody(params = { }, script = "showDecompressingAssets();" )
	private static native void showDecompress();

	@JSBody(params = { }, script = "showEnableScreen();" )
	private static native void showEnableScreen();

	@JSBody(params = { }, script = "showLoadingScreen();" )
	private static native void showLoadingScreen();
	...
	@JSBody(params = { "size", "maxSize" }, script = "updateLoadBar(size, maxSize);" )
	private static native void updateProgress(Event size, int maxSize);
