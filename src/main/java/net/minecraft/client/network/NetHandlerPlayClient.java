...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
		...
		if (ModManager.noRot.isEnabled()) {
            switch (ModManager.noRot.mode.getValue()) {
                case "Edit":
                    entityplayersp.setPosition(d0, d1, d2);
                ...
                case "Hypixel":
                    entityplayersp.setPosition(d0, d1, d2);
                    this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayersp.posX, entityplayersp.getEntityBoundingBox().minY, entityplayersp.posZ, f, f1, false));
                    break;
	...
	public void addToSendQueueWithoutEvent(Packet parPacket){
		this.netManager.sendPacketWithoutEvent(parPacket);
	}

	public void addToReceiveQueue(Packet pkt){
		this.netManager.receivePacket(pkt);
	}

	public void addToReceiveQueueWithoutEvent(Packet pkt){
		this.netManager.receivePacketNoEvent(pkt);
	}
	...
	public void handleAnimation(S0BPacketAnimation packetIn) {
		...
		if (entity != null) {
			if (packetIn.getAnimationType() == 0) {
				...
				entityplayersp.wakeUpPlayer(false, false, false);
