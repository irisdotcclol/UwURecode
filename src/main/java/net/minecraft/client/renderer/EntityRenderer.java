...
import dev.uwuclient.event.impl.MouseOverEvent;
...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	public void func_181560_a(float parFloat1, long parLong1) {
		...
		if (this.mc.inGameHasFocus && flag) {
			...
			float f1 = f * f * f * 8.0F;
            float f2 = (float) (this.mc.mouseHelper.deltaX + (this.mc.mouseHelper.deltaX != 0 ? FixedAimAssist.deltaX : 0)) * f1;
            float f3 = (float) (this.mc.mouseHelper.deltaY - (this.mc.mouseHelper.deltaY != 0 ? FixedAimAssist.deltaY : 0)) * f1;
			byte b0 = 1;
		...
		if (!this.mc.skipRenderWorld) {
			...
			if (this.mc.theWorld != null) {
				...
				if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
                    ...
                    EventRender2d e = new EventRender2d(parFloat1, scaledresolution);
					e.call();
					
					if(mc.thePlayer != null && mc.thePlayer.ticksExisted > 10){
						UwUClient.INSTANCE.notificationManager.amongus();
					}
